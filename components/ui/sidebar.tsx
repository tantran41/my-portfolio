          ...
          <div
            ...
            className={cn(
              ...
              openMobile
                ...
                ? "-translate-x-full"
                : "translate-x-full",
              "flex-col border-r bg-sidebar text-sidebar-foreground",
              className
            )}
            {...props}
          >
    ...
    return (
      <div
        ...
        className={cn(
          ...
          "[[data-side=left]_&]:border-r [[data-side=right]_&]:border-l",
          state === "collapsed" &&
            "[[data-collapsible=offcanvas]_&]:w-0 [[data-collapsible=icon]_&]:w-[--sidebar-width-icon]",
          className
        )}
        {...props}
      >
